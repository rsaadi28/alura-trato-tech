        ...
        <div className={styles.container}>
            ...
            <div className={styles.dados}>
                ...
                <div className={styles.content}>
                    {formaDePagamento !== '-' && (
                        <>
                            <p>A forma de pagamento {formaDePagamento.nome} tem a taxa de {formaDePagamento.taxa.toFixed(2)}x</p>
                            <p>O saldo desse cartão é de R$ {formaDePagamento.saldo.toFixed(2)}</p>
                        </>
                    )}
